> ⚠️ **Work in progress:** сейчас привожу репозиторий к воспроизводимому виду (структура папок, относительные пути, requirements, demo-данные).  
> Пайплайн уже реализован в ноутбуках `notebooks/` — витрина/документация дополняются.
