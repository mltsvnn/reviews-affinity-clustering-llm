>  **Статус:** репозиторий в процессе приведения к воспроизводимому виду (структура, относительные пути, requirements, демо-данные). Но пайплайн уже реализован и ноутбуки `notebooks/` отражают его актуальную логику.
